...
// let filteredInventors = inventors.filter(inventors => inventors.year >= 1500 && inventors.year <= 1600);
...
// let filteredMathematicians = inventors.filter(inventors => inventors.categories?.includes(`mathematician`));

// console.log(filteredMathematicians)
...
// let filteredManPhysicist = inventors.filter(inventors => inventors.categories?.includes(`physicist`) && inventors.categories?.includes(`man`));

// console.log(filteredManPhysicist)
...
// let firstNamelastName = inventors.map(inventors => inventors.first+" "+inventors.last);
...
// let inventorsMail = inventors.map(inventors => inventors.first+inventors.year+"@inventor.com");
// const nowInLowerCase = inventorsMail.map(inventorsMail => inventorsMail.toLowerCase());
// console.log(nowInLowerCase);

  // Array.prototype.sort()
  // 6. Sort the inventors by birthdate, youngest to oldest (eg: the one whose birth year is closer to us 
//   on top)
  // Expected output: an array of inventors going from "Katherine Blodgett" -> to "Nicolaus Copernicus"

// const sortetByYear = inventors.sort((a,b) => b.year - a.year);
// console.log(sortetByYear);

  // Array.prototype.reduce()
  // 7. How many years did all the inventors live all together?

// const totalYears = inventors.reduce((currentTotal, inventor) => inventor.year + currentTotal,0);
// console.log(totalYears);

// const totalPassed = inventors.reduce((currentTotal, inventor) => inventor.passed + currentTotal,0);
// console.log(totalPassed);

// const totalLifespan = totalPassed - totalYears;
// console.log(totalLifespan);

  // Array.prototype.sort()
  // 8. Sort the inventors by years lived

// const sortetByYearsLived = inventors.sort((yearDate,passedDate) => passedDate.passed - yearDate.year );
// console.log(sortetByYearsLived);
...
// const deBoulevard = boulevardsInParis.filter((de) => {
...
// console.log(deBoulevard);
  ...
  // const lastNameAlpha = people.sort();
...
// const howManyTimes = data.reduce((count,currentValue) => 
...
// const isEighteen = family.some((age) => age.year <= currentYear);
// console.log(isEighteen)

  // Array.prototype.every
  // 13. Do all names of the family members start with the letter L?

const hasEveryoneAnL = family.every((l) => l.name.charAt(0) === "L");
console.log(hasEveryoneAnL);